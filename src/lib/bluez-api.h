...
int bt_adapter(int argc, char *argv[]);
int bt_agent(int argc, char *argv[]);
int bt_audio(int argc, char *argv[]);
int bt_input(int argc, char *argv[]);
int bt_device(int argc, char *argv[]);
int bt_monitor(int argc, char *argv[]);
int bt_network(int argc, char *argv[]);
int bt_obex(int argc, char *argv[]);
int bt_serial(int argc, char *argv[]);
